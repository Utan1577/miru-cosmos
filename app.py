...
# NM: result & payout come from N3 (confirmed)
...
# ------------------------------------------------------------
# UI (outer design stays; center tuning + NOW hides result)
# ------------------------------------------------------------
html_code = f"""
<!DOCTYPE html>
<html>

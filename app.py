...
# ==========================================
# MIRU-PAD: MOBILE PERFECT FIT EDITION
# Logic: Python Backend
# UI: CSS Grid Force (No Horizontal Scroll)
# ==========================================
...
<style>
    ...
    /* [コントロールバー] (1段目) */
    /* Streamlitは勝手に縦並びにするので、強制的に横並び(flex-row)にする */
    ...
    div[data-testid="stHorizontalBlock"]:nth-of-type(2) > div[data-testid="column"]:nth-of-type(1) button {
        ...
        height: 55px !important; border-radius: 10px !important; font-size: 14px !important;
    }
...
<div class="lcd-box">
    ...
    <div style="display:grid; grid-template-columns:1fr 1fr; gap:0px 10px; width:100%; margin-top:15px; text-align:center;">
...
# 2. Control Bar
# CSSで強制的に横並びにされるので、ここの比率は見た目上の幅調整のみ
...
# 3. Game Grid (2 Columns)
# CSSで強制的に width: 50% にされる
g1, g2 = st.columns(2)
